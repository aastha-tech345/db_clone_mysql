...
TABLE_WITH_DATA="database_configs diseases global_category_types global_types mastercountry patient_medications_reasons recurring_settings roles snomedct_to_icd10 user_roles masterweekdays masterstate icd10 patient_medications "
